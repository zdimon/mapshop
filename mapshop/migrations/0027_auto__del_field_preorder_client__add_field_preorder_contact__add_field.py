...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Preorder.client'
        db.delete_column(u'mapshop_preorder', 'client_id')

        # Adding field 'Preorder.contact'
        db.add_column(u'mapshop_preorder', 'contact',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Preorder.type'
        db.add_column(u'mapshop_preorder', 'type',
                      self.gf('django.db.models.fields.CharField')(default='email', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Preorder.client'
        db.add_column(u'mapshop_preorder', 'client',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mapshop.Client']),
                      keep_default=False)

        # Deleting field 'Preorder.contact'
        db.delete_column(u'mapshop_preorder', 'contact')

        # Deleting field 'Preorder.type'
        db.delete_column(u'mapshop_preorder', 'type')
    ...
    models = {
        ...
        u'mapshop.preorder': {
            ...
            'contact': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mapshop.Product']"}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'email'", 'max_length': '5'})
        },
        u'mapshop.product': {
