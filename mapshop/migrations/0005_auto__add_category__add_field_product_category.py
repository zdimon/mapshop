...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mapshop_category', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'mapshop', ['Category'])

        # Adding field 'Product.category'
        db.add_column(u'mapshop_product', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mapshop.Category'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table(u'mapshop_category')

        # Deleting field 'Product.category'
        db.delete_column(u'mapshop_product', 'category_id')
