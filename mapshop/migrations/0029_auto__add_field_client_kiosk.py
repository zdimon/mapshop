...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.kiosk'
        db.add_column(u'mapshop_client', 'kiosk',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mapshop.Kiosk'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.kiosk'
        db.delete_column(u'mapshop_client', 'kiosk_id')
