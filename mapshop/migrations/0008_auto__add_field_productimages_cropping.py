...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductImages.cropping'
        db.add_column(u'mapshop_productimages', 'cropping',
                      self.gf(u'django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductImages.cropping'
        db.delete_column(u'mapshop_productimages', 'cropping')
