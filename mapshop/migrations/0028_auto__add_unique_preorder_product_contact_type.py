...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Preorder', fields ['product', 'contact', 'type']
        db.create_unique(u'mapshop_preorder', ['product_id', 'contact', 'type'])


    def backwards(self, orm):
        # Removing unique constraint on 'Preorder', fields ['product', 'contact', 'type']
        db.delete_unique(u'mapshop_preorder', ['product_id', 'contact', 'type'])
    ...
    models = {
        ...
        u'mapshop.preorder': {
            'Meta': {'unique_together': "(('product', 'contact', 'type'),)", 'object_name': 'Preorder'},
