...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mapshop_order', 'status', self.gf('django.db.models.fields.IntegerField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Order.status'
        db.alter_column(u'mapshop_order', 'status', self.gf('django.db.models.fields.CharField')(max_length=10))
